...
class PomodoroScreen2 extends StatefulWidget {
  const PomodoroScreen2({super.key, required this.todoId, this.title});

  final String? todoId;
  final String? title;

  @override
  State<PomodoroScreen2> createState() => _PomodoroScreen2State();
}

class _PomodoroScreen2State extends State<PomodoroScreen2> {
