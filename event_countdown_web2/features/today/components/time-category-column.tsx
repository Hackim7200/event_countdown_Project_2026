...
import { TIME_CATEGORIES, type Task, type TimeCategoryId } from "@/features/todo/types";
import { CategoryIcon } from "@/features/today/components/category-icon";
  ...
  return (
    <section className="space-y-4">
      <div className="flex items-center gap-3">
        <CategoryIcon icon={meta.icon} className="h-5 w-5 shrink-0 text-[#1A1A1A]" />
